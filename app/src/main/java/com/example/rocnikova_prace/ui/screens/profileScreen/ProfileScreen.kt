...
fun ProfileScreen(
    ...
    val avatarUrl = profileScreenViewModel.getUserAvatarUrl()
    val userName = profileScreenViewModel.getUserName()
        ...
        item {
            Row(
                modifier = Modifier
                    ...
                    .clickable(onClick = {
                        navController.navigate(MainScreen.DetailProfile.name)
                    }),
                ...
                Row(
                    ...
                    Box(
                        ...
                        CircularProgressIndicator(
                            progress = { score / 100f },
                            modifier = Modifier.fillMaxSize(),
                            color = if (score >= 80) Color(0xFF4CAF50) else if (score >= 50) Color(0xFFFFC107) else Color(0xFFF44336),
                            strokeWidth = 4.dp
                        )
